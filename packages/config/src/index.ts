...
export const PERSISTENT_DATABASE_URL = process.env.PERSISTENT_DATABASE_URL as string;
export const WEB_BASE_URL = process.env.WEB_BASE_URL as string;
export const BACKEND_PUBLIC_URL = process.env.BACKEND_PUBLIC_URL as string;
